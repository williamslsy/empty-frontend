...
export const MenuMobile: React.FC<Props> = ({ open, setIsOpen }) => {
  return (
    <div
      className={twMerge(
        "fixed top-[58px] left-0 w-dvw h-[calc(100dvh-58px)] bg-tw-bg z-[100] p-4 pt-10 pb-32 flex flex-col gap-4 items-center justify-between transition-all duration-300",
