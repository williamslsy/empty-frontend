...
export type RequestFnParameters<rpcSchema extends RpcSchema | undefined = undefined> = rpcSchema extends RpcSchema
  ? {
...
export type RequestFn<rpcSchema extends RpcSchema | undefined = undefined> = <
  ...
  _parameters extends RequestFnParameters<DerivedRpcSchema<rpcSchema, rpcSchemaOverride>> = RequestFnParameters<
    DerivedRpcSchema<rpcSchema, rpcSchemaOverride>
  >,
  _returnType = DerivedRpcSchema<rpcSchema, rpcSchemaOverride> extends RpcSchema
    ? Extract<DerivedRpcSchema<rpcSchema, rpcSchemaOverride>[number], { Method: _parameters["method"] }>["ReturnType"]
    : unknown
>(
  args: _parameters,
