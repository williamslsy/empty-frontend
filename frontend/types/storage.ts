...
> = {
  key: string;
  getItem<key extends keyof storageItemMap, value extends storageItemMap[key], defaultValue extends value | null | undefined>(
    key: key,
...
export type CreateStorageParameters = {
  ...
  storage?: Prettify<BaseStorage> | undefined;
};
